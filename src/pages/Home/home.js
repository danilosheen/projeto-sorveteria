          ...
          <section className="conteudo">
            ...
            <div className="container-text">
              ...
              <p>
                ...
                frutas e sem nenhum conservante! Também temos opçoes sem lactose
                e sem açúcar. Venha conhecer e perceber que tem como o sorvete
                ser decicioso e saudável ao mesmo tempo!
              </p>
            </div>
          </section>
          ...
          <section className="conteudo">
            <div className="container-text segundo-container">
              ...
              <p>
                ...
                com os melhores sorvetes da sua vida! Venha nos conhecer e
                passar um tempinho aqui com a gente.
              </p>
            </div>
            <div className="container-img">
